...
export default function Topbar({ months, month, asOf }: { months: string[]; month: string; asOf: string }) {
  return (
    <header className="sticky top-0 z-40 border-b border-line-soft bg-ground/80 backdrop-blur">
      <div className="mx-auto flex h-14 w-full max-w-[1480px] items-center justify-between gap-6 px-6">
        ...
        <div className="shrink-0"><MonthSelect months={months} month={month} /></div>
      </div>
    </header>
  );
}
