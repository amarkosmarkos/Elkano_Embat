...
const cases: Record<"a" | "b", SlideContent> = {
  a: {
    ...
    proof: { heading: "Su grupo le cubre al 2 % en vez del 6 % del banco, con revisión.", text: "151.900 € por cash pooling desde Iris Labs y Kite Fabrics, limitado al 75 % y con revisión; 479 € de ahorro en 30 días. Más 24.024 € de Harbor Foods por la red al 15,10 %.", button: "Notas y enlaces", figures: [["151.900 €", "cash pooling"], ["24.024 €", "marketplace"]] },
