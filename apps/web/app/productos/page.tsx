...
export default function ProductosPage() {
  return (
    <>
      <PageHeader eyebrow="Productos" title="El score es el motor. Esto es lo que se vende." lead="Dos decisiones sobre el mismo número, con el mismo comprador: la empresa que ya le da los datos a Embat." />
