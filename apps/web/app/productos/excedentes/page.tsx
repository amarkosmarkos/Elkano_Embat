export default function ExcedentesPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-14">
      <div className="mb-3 text-[13px] font-semibold uppercase tracking-wide text-ink-mute">Producto 01</div>
      <h1 className="text-4xl font-bold tracking-tight text-ink">Colocación de excedentes</h1>
      ...
      <div className="mt-8 rounded-2xl border border-line bg-panel p-6 shadow-sm">
        <div className="font-mono text-3xl font-semibold text-ink">535 M€ · 312 empresas</div>
