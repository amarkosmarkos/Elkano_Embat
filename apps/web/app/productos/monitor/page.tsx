export default function MonitorPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-14">
      <div className="mb-3 font-mono text-[11.5px] uppercase tracking-widest text-ink-mute">Producto 03</div>
      <h1 className="font-display text-4xl font-extrabold">Alerta de cuotas + recomendación de pagos</h1>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="rounded-sm border border-line bg-panel p-6">
          <div className="font-mono text-2xl font-semibold text-accent">163 empresas</div>
        ...
        <div className="rounded-sm border border-line bg-panel p-6">
          <div className="font-mono text-2xl font-semibold text-accent">2.300 M€/año</div>
