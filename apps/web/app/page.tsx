  ...
  return (
    <>
      <PageHeader
        ...
        subtitle={`Extractos bancarios y facturas de ${fmtInt(o.n_companies)} empresas conectadas a Embat, ${o.months} meses hasta ${fmtMonthLong(o.month_last)}. Un tesorero mira su empresa; nadie puede mirar las ${fmtInt(o.n_companies)}.`}
      />
      ...
      <div className="mt-8 mb-3 flex items-baseline justify-between">
        <h2 className="text-lg font-bold text-navy">Siete ventanas a la misma empresa</h2>
        <span className="text-[12px] text-ink-2">Cada una cuenta una verdad parcial</span>
      </div>
      ...
      <div className="mt-8 grid grid-cols-3 gap-3">
        <div className="card p-4">
          <div className="kicker">Qué es «ir mal»</div>
          <p className="text-[13px] text-ink-2 mt-1 leading-snug">
            En tesorería tiene una definición concreta: quedarse sin caja, dejar de pagar o que te dejen de pagar. Todo lo demás existe para anticipar eso.
          </p>
        </div>
        <div className="card p-4">
